...
/**
 * Configures WebFlux resource handlers to serve the bundled Redoc standalone JS file.
 *
 ...
 */
public class RedocWebFluxResourceConfigurer implements WebFluxConfigurer {
