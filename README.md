...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.chandanv89/springdoc-openapi-starter-webmvc-redoc)](https://central.sonatype.com/artifact/io.github.chandanv89/springdoc-openapi-starter-webmvc-redoc)
...
**Default look**: Inter font for body/headings, JetBrains Mono for code blocks, with full theme customisation support.
...
> **Note:** Replace `${redoc.version}` below with the latest version from the Maven Central badge above.
...
dependencies {
  ...
  implementation 'io.github.chandanv89:springdoc-openapi-starter-webmvc-redoc:${redoc.version}'
}
```
